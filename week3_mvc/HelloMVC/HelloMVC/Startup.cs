...
namespace HelloMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // that enables greater separation of concerns
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            // action method will be called instantiated and called to handle the current
            // request
            // MVC uses a lot of anonymous types
            app.UseMvc(routes =>
            {
